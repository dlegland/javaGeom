...
public class CheckFindIntersections extends JPanel {
    ...
    ICirculinearContinuousCurve2D parallel1;
    ICirculinearContinuousCurve2D parallel2;
    ...
    public void paintComponent(Graphics g) {
        ...
        for (ICirculinearContinuousCurve2D cont : CirculinearCurves2D.splitContinuousCurve(parallel2)) {
