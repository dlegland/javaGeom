...
public class CheckGetBufferLinearRing2 extends JPanel {
    ...
    public CheckGetBufferLinearRing2() {
        ...
        curve = new LinearRing2D(new Point2D[] { new Point2D(200, 100), new Point2D(300, 100), new Point2D(300, 200), new Point2D(200, 200), new Point2D(100, 200), new Point2D(100, 100) });
