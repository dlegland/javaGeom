...
/**
 * Check if a continuous contour (here a linear ring) which self-intersects is correctly spitted into disjoint parts.
 * 
 * @author dlegland
 *
 */
public class CheckBufferSelfIntersectingContour extends JPanel {
    ...
    public CheckBufferSelfIntersectingContour() {
        ...
        curve = new LinearRing2D(new Point2D[] { new Point2D(100, 300), new Point2D(500, 300), new Point2D(500, 500), new Point2D(300, 500), new Point2D(300, 100), new Point2D(100, 100) });
    }
