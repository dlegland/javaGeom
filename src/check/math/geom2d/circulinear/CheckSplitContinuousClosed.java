...
public class CheckSplitContinuousClosed extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        Color[] colors = new Color[] { Color.RED, Color.GREEN, Color.CYAN, Color.MAGENTA, Color.ORANGE };
        int i = 0;

        g2.setColor(Color.BLUE);
        for (ICirculinearContinuousCurve2D cont : CirculinearCurves2D.splitContinuousCurve(curve)) {
