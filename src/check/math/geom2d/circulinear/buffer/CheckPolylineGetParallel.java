...
public class CheckPolylineGetParallel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        BufferCalculator bc2 = new BufferCalculator(new BevelJoinFactory(), new TriangleCapFactory());
        BufferCalculator bc3 = new BufferCalculator(new MiterJoinFactory(), new SquareCapFactory());

        ICurve2D parallel1, parallel1i, parallel2, parallel2i, parallel3, parallel3i;
