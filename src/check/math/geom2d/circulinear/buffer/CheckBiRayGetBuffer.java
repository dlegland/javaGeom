...
public class CheckBiRayGetBuffer extends JPanel {
    ...
    PolyCirculinearCurve2D<ICirculinearElement2D> curve;
    ...
    public CheckBiRayGetBuffer() {
        ...
        // create the curve
        curve = new PolyCirculinearCurve2D<ICirculinearElement2D>();
        curve.add(ray1);
        curve.add(ray2);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        ICirculinearContinuousCurve2D parallel1 = bc.createContinuousParallel(curve, 50);
        ICirculinearContinuousCurve2D parallel2 = bc.createContinuousParallel(curve, -50);
