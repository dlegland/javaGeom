...
public class CheckBufferCapsJoins extends JPanel {
    ...
    public CheckBufferCapsJoins() {
        ...
        curve1 = new Polyline2D(new Point2D[] { new Point2D(50, 250), new Point2D(130, 250), new Point2D(130, 190), new Point2D(50, 110), new Point2D(50, 50), new Point2D(130, 50), });

        AffineTransform2D trans = AffineTransform2D.createTranslation(150, 0);
    ...
    public void paintComponent(Graphics g) {
        ...
        BufferCalculator bc2 = new BufferCalculator(new RoundJoinFactory(), new ButtCapFactory());
        BufferCalculator bc3 = new BufferCalculator(new BevelJoinFactory(), new TriangleCapFactory());
        BufferCalculator bc4 = new BufferCalculator(new MiterJoinFactory(), new SquareCapFactory());

        IDomain2D domain1, domain2, domain3, domain4;
