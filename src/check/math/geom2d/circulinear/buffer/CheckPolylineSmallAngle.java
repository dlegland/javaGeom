...
public class CheckPolylineSmallAngle extends JPanel {
    ...
    public CheckPolylineSmallAngle() {
        ...
        polyline = new Polyline2D(new Point2D[] { new Point2D(250, 200), new Point2D(150, 200), new Point2D(230, 230), });
    ...
    public void paintComponent(Graphics g) {
        ...
        BufferCalculator bc = new BufferCalculator(new RoundJoinFactory(), new RoundCapFactory());

        ICurve2D parallel1, parallel2;

        parallel1 = bc.createContinuousParallel(polyline, 50);
        parallel2 = bc.createContinuousParallel(polyline, -50);

        IDomain2D buffer = bc.computeBuffer(polyline, 40);
