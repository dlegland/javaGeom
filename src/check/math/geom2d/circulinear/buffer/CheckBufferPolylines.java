...
public class CheckBufferPolylines extends JPanel {
    ...
    public CheckBufferPolylines() {
        ...
        curve1 = new Polyline2D(new Point2D[] { new Point2D(50, 50), new Point2D(50, 100), new Point2D(100, 100), new Point2D(100, 50), new Point2D(150, 100), new Point2D(150, 50), });

        AffineTransform2D tx = AffineTransform2D.createTranslation(200, 0);
        AffineTransform2D ty = AffineTransform2D.createTranslation(0, 150);
    ...
    public void paintComponent(Graphics g) {
        ...
        BufferCalculator bc2 = new BufferCalculator(new MiterJoinFactory(), new SquareCapFactory());
        BufferCalculator bc3 = new BufferCalculator(new BevelJoinFactory(), new TriangleCapFactory());
        BufferCalculator bc4 = new BufferCalculator(new MiterJoinFactory(), new ButtCapFactory());

        IDomain2D buffer1, buffer2, buffer3, buffer4;
