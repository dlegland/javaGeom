...
public class CheckSplitContinuousOpen extends JPanel {
    ...
    public CheckSplitContinuousOpen() {
        ...
        LineSegment2D line1 = new LineSegment2D(new Point2D(50, 100), new Point2D(200, 100));
    ...
    public void paintComponent(Graphics g) {
        ...
        Iterator<? extends ICirculinearContinuousCurve2D> iterator = CirculinearCurves2D.splitContinuousCurve(curve).iterator();

        ICirculinearContinuousCurve2D curve1 = iterator.next();
        curve1.draw(g2);
        g2.setColor(Color.RED);
        ICirculinearContinuousCurve2D curve2 = iterator.next();
        curve2.draw(g2);
    }
