...
public class CheckBufferPolyCurveColinear extends JPanel {
    ...
    public CheckBufferPolyCurveColinear() {
        ...
        LineSegment2D line1 = new LineSegment2D(new Point2D(200, 100), new Point2D(400, 100));
        CircleArc2D arc1 = new CircleArc2D(new Point2D(400, 200), 100, 3 * Math.PI / 2, Math.PI);
        LineSegment2D line2 = new LineSegment2D(new Point2D(400, 300), new Point2D(200, 300));
