...
public class CheckIntersectPolyline2D extends JPanel {
    ...
    public CheckIntersectPolyline2D() {
        ...
        polyline1 = new Polyline2D(new Point2D[] { new Point2D(50, 50), new Point2D(150, 50), new Point2D(150, 150), new Point2D(50, 150) });

        polyline2 = new LinearRing2D(new Point2D[] { new Point2D(80, 80), new Point2D(200, 80), new Point2D(200, 120), new Point2D(120, 120), new Point2D(120, 200), new Point2D(80, 200) });
