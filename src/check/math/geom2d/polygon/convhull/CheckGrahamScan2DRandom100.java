...
/**
 * Check computation of convex hull using Graham scan, on a random set of 100 points with coordinate generated between 100 and 300.
 * 
 * @author dlegland
 *
 */
public class CheckGrahamScan2DRandom100 extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        IPolygon2D hull = new GrahamScan2D().convexHull(points.points());
