...
public class DrawClosestPointTriangleGrid2D extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        Point2D[] points = new Point2D[] { new Point2D(x0 + s / 3 + 3 * s, y0 + s / 3), new Point2D(x0 + 2 * s / 3 + 3 * s, y0 + s / 3), new Point2D(x0 + s / 2 + 3 * s, y0 + 2 * s / 3), new Point2D(x0 + s / 2 + 3 * s, y0 - s / 2) };
