...
public abstract class Curve2DUtils {
	...
	public final static CurveSet2D<Curve2D> clipCurve(Curve2D curve, Box2D box){
		...
		if(curve instanceof ContinuousCurve2D)
			return new CurveSet2D<Curve2D>(
					Curve2DUtils.clipContinuousCurve(
	...
	/**
	 * <p>Clips a continuous curve and returns a set of continuous curves.</p>
	 * <p>Algorithm is the following one:
	 * <ul>
	 ...
	 *   of the box</li>
	 * </ul></p>
	 * <p>Special processing is added when the first point of the curve lies on
	 * the boundary of the box, and when the curve is closed (when the first
	 * point of the curve is inside the box, the method return a portion of 
	 * curve between the last intersection and the first intersection).</p>
	 * 
	 */
	 ...
	 * This method is mainly used to help debugging when implementing curves.
	 */
