...
public class JarvisMarch {
	...
	/**
	 * Computes the convex hull of a set of points as a single Polygon2D.
	 * Current implementation start at the point with lowest y-coord.
	 * The points are considered in counter-clockwise order.
	 * Result is an instance of SimplePolygon2D.
	 * Complexity is O(n*h), with n number of points, h number of points of
	 * the hull. Worst case complexity is O(n^2).
	 */
