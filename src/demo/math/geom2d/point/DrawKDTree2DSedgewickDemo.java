...
/**
 * Check computation of kd-tree using Jarvis March, on point set given in R. Sedgewick's book.
 * 
 * @author dlegland
 *
 */
public class DrawKDTree2DSedgewickDemo extends JPanel {
    ...
    public DrawKDTree2DSedgewickDemo() {
        super();
    ...
    public void paintComponent(Graphics g) {
        ...
        new Box2D(100, 300, 100, 300).draw(g2);
    }

    private void drawTree(Graphics2D g2, KDTree2D.Node node, int step, double xmin, double xmax, double ymin, double ymax) {
        if (node == null)
            return;
    ...
    public final static void main(String[] args) {
        JPanel panel = new DrawKDTree2DSedgewickDemo();
