...
public class DrawCircularShapeDemo extends JPanel {
    ...
    public DrawCircularShapeDemo() {
        ...
        IContour2D boundarylu = new Circle2D(xl, yu, r2, false);
        IContour2D boundaryuu = new Circle2D(xl, yl, r2, false);
        IContour2D boundaryul = new Circle2D(xu, yl, r2, false);
