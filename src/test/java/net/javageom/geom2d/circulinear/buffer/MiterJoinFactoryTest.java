...
import net.javageom.geom2d.circulinear.buffer.JoinFactory;
import net.javageom.geom2d.circulinear.buffer.MiterJoinFactory;
import net.javageom.geom2d.circulinear.buffer.RoundCapFactory;
...
public class MiterJoinFactoryTest extends TestCase {
	...
	/**
	 * Test method for {@link net.javageom.geom2d.circulinear.buffer.MiterJoinFactory#createJoin(net.javageom.geom2d.circulinear.CirculinearElement2D, net.javageom.geom2d.circulinear.CirculinearElement2D, double)}.
	 */
