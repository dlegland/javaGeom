...
public class AffineTransform3DTest extends TestCase {
    ...
    public void testCreateRotationOx_Double() {
        ...
        AffineTransform3D T1 = new AffineTransform3D(1, 0, 0, 0, 0, cot, -sit, 0, 0, sit, cot, 0);
    ...
    public void testCreateRotationOy_Double() {
        ...
        AffineTransform3D T1 = new AffineTransform3D(cot, 0, sit, 0, 0, 1, 0, 0, -sit, 0, cot, 0);
    ...
    public void testCreateRotationOz_Double() {
        ...
        AffineTransform3D T1 = new AffineTransform3D(cot, -sit, 0, 0, sit, cot, 0, 0, 0, 0, 1, 0);
    ...
    public void testTransformPoints_Array() {
        ...
        Point3D[] pts = new Point3D[] { new Point3D(10, 10, 10), new Point3D(10, 20, 30) };
