...
public class PointArray2DTest extends TestCase {
    ...
    public void testGetBuffer_Disjoint() {
        ...
        IPointSet2D set = PointArray2D.create(new Point2D[] { p1, p2, p3 });

        IDomain2D buffer = set.buffer(5);
    ...
    public void testGetBuffer_Merge() {
        ...
        IDomain2D buffer = set.buffer(10);
        IBoundary2D boundary = buffer.boundary();
    ...
    public void testGetDistancePoint2D() {
        PointArray2D set = new PointArray2D(new Point2D[] { new Point2D(0, 0), new Point2D(10, 0), new Point2D(0, 10), new Point2D(10, 10) });
    ...
    public void testIsEmpty() {
        ...
        set = new PointArray2D(new Point2D[] { new Point2D(0, 0), new Point2D(10, 0), new Point2D(0, 10), new Point2D(10, 10) });
        assertTrue(!set.isEmpty());
    ...
    public void testCopyConstructor() {
        PointArray2D set = new PointArray2D(new Point2D[] { new Point2D(0, 0), new Point2D(10, 20), new Point2D(30, 40) });
