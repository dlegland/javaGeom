...
public class Curves2DTest extends TestCase {
    ...
    public void testClipCurve_LineSegment2D() {
        ...
        ICurveSet2D<? extends ICurve2D> curveSet = Curves2DUtil.clipCurve(line1, box);
    ...
    public void testClipCurve_CircleArc2D() {
        ...
        ICurveSet2D<? extends ICurve2D> clipped1 = Curves2DUtil.clipCurve(arc1, box);
        ICurve2D curve1 = clipped1.firstCurve();

        ICurveSet2D<? extends ICurve2D> clipped2 = Curves2DUtil.clipCurve(arc2, box);
    ...
    public void testClipCurve_CurveSet2D() {
        ...
        ICurveSet2D<? extends ICurve2D> clippedSet = Curves2DUtil.clipCurve(set, box);
    ...
    public void testClipCurve_Polyline2D() {
        ...
        ICurveSet2D<? extends ICurve2D> clip1 = Curves2DUtil.clipCurve(poly1, box);
    ...
    public void testFindNextCurveIndex() {
        ...
        assertEquals(Curves2DUtil.findNextCurveIndex(tab1, .1), 3);
        assertEquals(Curves2DUtil.findNextCurveIndex(tab1, .5), 2);
        assertEquals(Curves2DUtil.findNextCurveIndex(tab1, .3), 5);
        assertEquals(Curves2DUtil.findNextCurveIndex(tab1, .8), 3);
    }
    ...
    public void testGetJunctionType_LineLineAcute() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(line1, line2);
        assertEquals(Curves2DUtil.JunctionType.SALIENT, type);
    }
    ...
    public void testGetJunctionType_LineLineObtuse() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(line1, line2);
        assertEquals(Curves2DUtil.JunctionType.REENTRANT, type);
    }
    ...
    public void testGetJunctionType_LineLineFlat() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(line1, line2);
        assertEquals(Curves2DUtil.JunctionType.FLAT, type);
    }
    ...
    public void testGetJunctionType_LineArcAcute() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(line, arc);
        assertEquals(Curves2DUtil.JunctionType.SALIENT, type);
    }
    ...
    public void testGetJunctionType_ArcLineAcute() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(arc, line);
        assertEquals(Curves2DUtil.JunctionType.SALIENT, type);
    }
    ...
    public void testGetJunctionType_Arcs_Reentrant() {
        ...
        Curves2DUtil.JunctionType type = Curves2DUtil.getJunctionType(arc1, arc2);
        assertEquals(Curves2DUtil.JunctionType.REENTRANT, type);
    }
