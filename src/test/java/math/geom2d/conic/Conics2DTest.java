...
public class Conics2DTest extends TestCase {
    ...
    public void testTransformCenteredEllipse() {
        ...
        double[] back = Conics2D.transformCentered(transformed, AffineTransform2D.createRotation(-Math.PI / 3));
        for (int i = 0; i < 3; i++)
    ...
    public void testReduceConic_HorizontalParabola() {
        ...
        assertEquals(Angle2DUtil.formatAngle(parabola.getAngle()), 3 * Math.PI / 2, eps);
    ...
    public void testReduceConic_VerticalParabola() {
        ...
        parabola = (Parabola2D) conic;
        assertEquals(parabola.getVertex(), vertex);
        assertEquals(Angle2DUtil.formatAngle(parabola.getAngle()), 0, eps);
        assertEquals(parabola.getParameter(), 3, eps);
    }
    ...
    public void testReduceConicEllipse() {
        ...
        IEllipseShape2D rotated = ellipse.transform(AffineTransform2D.createRotation(-theta));
    ...
    public void testReduceConicTwoStraightLines() {
        ...
        assertEquals(conic.conicType(), IConic2D.Type.TWO_LINES);
