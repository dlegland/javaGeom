...
public class Point2DTest extends TestCase {
    ...
    public void testGetDistancePoint2D() {
        ...
        assertEquals(p1.distance(p1), 0, IShape2D.ACCURACY);
        assertEquals(p2.distance(p1), Math.sqrt(2), IShape2D.ACCURACY);
        assertEquals(p3.distance(p1), 1, IShape2D.ACCURACY);
        assertEquals(p2.distance(p2), 0, IShape2D.ACCURACY);
        assertEquals(p3.distance(p2), 1, IShape2D.ACCURACY);
        assertEquals(p3.distance(p3), 0, IShape2D.ACCURACY);
    ...
    public void testGetDistancedoubledouble() {
        Point2D p1 = new Point2D(2, 3);
        assertEquals(p1.distance(2, 3), 0, IShape2D.ACCURACY);
        assertEquals(p1.distance(1, 3), 1, IShape2D.ACCURACY);
        assertEquals(p1.distance(2, 4), 1, IShape2D.ACCURACY);
        assertEquals(p1.distance(2, 2), 1, IShape2D.ACCURACY);
        assertEquals(p1.distance(1, 2), Math.sqrt(2), IShape2D.ACCURACY);
        assertEquals(p1.distance(0, 0), Math.sqrt(13), IShape2D.ACCURACY);
    }
    ...
    public void testCentroid_Array() {
        Point2D[] points = new Point2D[] { new Point2D(50, 60), new Point2D(110, 60), new Point2D(150, 140), new Point2D(90, 140) };
        Point2D centroid = Point2D.centroid(points);
        assertEquals(new Point2D(100, 100), centroid);
    }

    public void testCentroid_ArrayArray() {
        Point2D[] points = new Point2D[] { new Point2D(10, 10), new Point2D(20, 10), new Point2D(10, 20) };
    ...
    public void testCreatePolar() {
        ...
        assertTrue(p1.distance(p2) < IShape2D.ACCURACY);
    }
    ...
    public void testRotate() {
        ...
        assertTrue(p1r.distance(p2) < IShape2D.ACCURACY);

        // test with center
        Point2D p3 = new Point2D(0, 10);
        Point2D p1rc = p1.rotate(new Point2D(10, 10), Math.PI / 2);
        assertTrue(p1rc.distance(p3) < IShape2D.ACCURACY);
    }
