...
public class GenericCirculinearRing2DTest extends TestCase {
    ...
    public void testClipBox2D_Astroid() {
        ...
        ICurve2D clipped = ring.clip(box);
    ...
    public void testIsInsidePoint2D_CurvedBand() {
        ...
        LineSegment2D line1 = new LineSegment2D(new Point2D(x0, y0), new Point2D(x1, y1));
        double diam = 2 * r1 + 2 * r2;
        LineSegment2D line2 = new LineSegment2D(new Point2D(x1 + diam, y1), new Point2D(x0 + diam, y0));

        GenericCirculinearRing2D ring = new GenericCirculinearRing2D(arc1, arc2, line1, arc3, arc4, line2);
    ...
    public void testGetBuffer_Astroid() {
        ...
        IDomain2D buffer = ring.buffer(20);
