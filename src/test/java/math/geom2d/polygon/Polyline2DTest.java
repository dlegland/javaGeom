...
public class Polyline2DTest extends TestCase {
    ...
    public void testGetLength() {
        Polyline2D polyline = new Polyline2D(new Point2D[] { new Point2D(0, 0), new Point2D(10, 0), new Point2D(10, 10), new Point2D(20, 10) });
    ...
    public void testGetBufferDouble() {
        Polyline2D polyline = new Polyline2D(new Point2D[] { new Point2D(50, 50), new Point2D(100, 50), new Point2D(100, 100), new Point2D(150, 100) });
        double dist = 30;

        IDomain2D buffer = polyline.buffer(dist);
    ...
    public void testGetBufferDouble_MultipleVertex() {
        Polyline2D polyline = new Polyline2D(new Point2D[] { new Point2D(50, 50), new Point2D(100, 50), new Point2D(100, 50), new Point2D(100, 100), new Point2D(150, 100) });
        double dist = 30;
    ...
    public void testGetParallelDouble() {
        ...
        ICirculinearContinuousCurve2D parallel = polyline.parallel(30);
        assertTrue(parallel != null);
    }

    public void testGetLeftTangent() {
        Polyline2D line = new Polyline2D(new Point2D[] { new Point2D(10, 10), new Point2D(20, 10), new Point2D(20, 20) });
    ...
    public void testGetPosition() {
        Polyline2D line = new Polyline2D(new Point2D[] { new Point2D(0, 0), new Point2D(10, 0), new Point2D(10, 10), new Point2D(20, 20) });
        double eps = 1e-14;
    ...
    public void testGetSubCurve() {
        ...
        // to check result
        Polyline2D line2 = new Polyline2D(new Point2D[] { new Point2D(5, 0), new Point2D(10, 0), new Point2D(10, 10), new Point2D(15, 15) });
    ...
    public void testIsInside() {
        Polyline2D polyline = new Polyline2D(new Point2D[] { new Point2D(150, 50), new Point2D(150, 150), new Point2D(100, 100), new Point2D(50, 150), new Point2D(50, 50) });
