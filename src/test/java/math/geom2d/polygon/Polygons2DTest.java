...
public class Polygons2DTest extends TestCase {
    ...
    /**
     * Test method for {@link math.geom2d.polygon.Polygons2D#union(math.geom2d.polygon.IPolygon2D, math.geom2d.polygon.IPolygon2D)}.
     */
    public void testUnion_Intersecting() {
        ...
        IPolygon2D poly1 = new SimplePolygon2D(new Point2D[] { pa1, pa2, pa3, pa4 });
        ...
        IPolygon2D poly2 = new SimplePolygon2D(new Point2D[] { pb1, pb2, pb3, pb4 });

        IPolygon2D union = Polygons2D.union(poly1, poly2);
        assertNotNull(union);
    ...
    public void testUnion_TwoConcentricRings() {
        LinearRing2D outerRing1 = LinearRing2D.create(new Point2D[] { new Point2D(50, 50), new Point2D(450, 50), new Point2D(450, 450), new Point2D(50, 450) });
        LinearRing2D innerRing1 = LinearRing2D.create(new Point2D[] { new Point2D(100, 100), new Point2D(100, 400), new Point2D(400, 400), new Point2D(400, 100) });
        IPolygon2D poly1 = MultiPolygon2D.create(new LinearRing2D[] { outerRing1, innerRing1 });

        LinearRing2D outerRing2 = LinearRing2D.create(new Point2D[] { new Point2D(150, 150), new Point2D(350, 150), new Point2D(350, 350), new Point2D(150, 350) });
        LinearRing2D innerRing2 = LinearRing2D.create(new Point2D[] { new Point2D(200, 200), new Point2D(200, 300), new Point2D(300, 300), new Point2D(300, 200) });
        IPolygon2D poly2 = MultiPolygon2D.create(new LinearRing2D[] { outerRing2, innerRing2 });
    ...
    public void testUnion_TwoIntersectingRings() {
        LinearRing2D outerRing1 = LinearRing2D.create(new Point2D[] { new Point2D(50, 150), new Point2D(350, 150), new Point2D(350, 450), new Point2D(50, 450) });
        LinearRing2D innerRing1 = LinearRing2D.create(new Point2D[] { new Point2D(100, 200), new Point2D(100, 400), new Point2D(300, 400), new Point2D(300, 200) });
        IPolygon2D poly1 = MultiPolygon2D.create(new LinearRing2D[] { outerRing1, innerRing1 });

        LinearRing2D outerRing2 = LinearRing2D.create(new Point2D[] { new Point2D(150, 50), new Point2D(450, 50), new Point2D(450, 350), new Point2D(150, 350) });
        LinearRing2D innerRing2 = LinearRing2D.create(new Point2D[] { new Point2D(200, 100), new Point2D(200, 300), new Point2D(400, 300), new Point2D(400, 100) });
        IPolygon2D poly2 = MultiPolygon2D.create(new LinearRing2D[] { outerRing2, innerRing2 });
    ...
    public void testIntersection_Intersecting() {
        ...
        IPolygon2D inter = Polygons2D.intersection(poly1, poly2);
        assertNotNull(inter);
    ...
    public void testIntersection_TwoConcentricRings() {
        ...
        IPolygon2D union = Polygons2D.intersection(poly1, poly2);
        assertNotNull(union);
    ...
    /**
     * Test with two shifted squares. The result is a square with a corner removed.
     */
    public void testDifference_ShiftedSquares() {
        ...
        // compute difference
        IPolygon2D diff = Polygons2D.difference(poly1, poly2);
        assertNotNull(diff);
    ...
    /**
     * Test with two nested squares. The result is a square polygon with a square hole.
     */
    ...
    public void testExclusiveOr_ShiftedSquares() {
        ...
        IPolygon2D xor = Polygons2D.exclusiveOr(poly1, poly2);
        assertNotNull(xor);
    ...
    /**
     * Computes the buffer of two polygons close to each other. The result should be composed of only one curve.
     */
    public void testBufferTwoClosePolygons() {
        LinearRing2D ring1 = new LinearRing2D(new Point2D[] { new Point2D(50, 100), new Point2D(100, 100), new Point2D(100, 150), new Point2D(50, 150) });
        LinearRing2D ring2 = new LinearRing2D(new Point2D[] { new Point2D(150, 100), new Point2D(200, 100), new Point2D(220, 125), new Point2D(200, 150), new Point2D(10, 150) });

        IPolygon2D polygon = new MultiPolygon2D(new LinearRing2D[] { ring1, ring2 });

        IDomain2D domain = Polygons2D.createBuffer(polygon, 30);
