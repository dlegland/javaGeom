...
public class SimplePolygon2DTest extends TestCase {
    ...
    public void testTransform_Inversion() {
        ...
        IDomain2D poly2 = poly.transform(inversion);
    ...
    public void testTransform_Motion() {
        ...
        AffineTransform2D transfo = AffineTransform2D.createRotation(center, angle);

        IPolygon2D poly2 = poly.transform(transfo);
        ...
        assertTrue(dist < IShape2D.ACCURACY);
    }
    ...
    public void testTransform_Reflect() {
        ...
        AffineTransform2D transfo = AffineTransform2D.createLineReflection(line);
    ...
    public void testGetCentroiddoubledouble() {
        ...
        poly = new SimplePolygon2D(new Point2D[] { new Point2D(10, 0), new Point2D(10, 10), new Point2D(0, 10), new Point2D(0, 20), new Point2D(10, 20), new Point2D(10, 30), new Point2D(20, 30), new Point2D(20, 20), new Point2D(30, 20), new Point2D(30, 10), new Point2D(20, 10), new Point2D(20, 0) });
    ...
    public void testGetBuffer_Square() {
        SimplePolygon2D polygon = new SimplePolygon2D(new Point2D[] { new Point2D(100, 100), new Point2D(150, 100), new Point2D(150, 150), new Point2D(100, 150) });

        ICirculinearDomain2D buffer = polygon.buffer(10);
        IBoundary2D boundary = buffer.boundary();
        assertEquals(1, boundary.continuousCurves().size());

        IContour2D contour = boundary.continuousCurves().iterator().next();
        assertEquals(8, contour.smoothPieces().size());
    }

    public void testGetBuffer_MutipleVertices() {
        SimplePolygon2D polygon = new SimplePolygon2D(new Point2D[] { new Point2D(100, 100), new Point2D(150, 100), new Point2D(150, 100), new Point2D(150, 150), new Point2D(100, 150) });
    ...
    public void testClipBox2D_inside() {
        ...
        IPolygon2D clipped = polygon.clip(box);
        assertEquals(1, clipped.contours().size());
    }

    public void testClipBox2D_intersect() {
        SimplePolygon2D polygon = new SimplePolygon2D(new Point2D[] { new Point2D(100, 100), new Point2D(300, 100), new Point2D(300, 300), new Point2D(100, 300) });
    ...
    public void testClipBox2D_intersectMulti() {
        SimplePolygon2D polygon = SimplePolygon2D.create(new Point2D[] { new Point2D(40, 120), new Point2D(120, 120), new Point2D(120, 160), new Point2D(80, 160), new Point2D(80, 220), new Point2D(140, 220), new Point2D(140, 180), new Point2D(180, 180), new Point2D(180, 260), new Point2D(40, 260) });
    ...
    public void testClipBox2D_CWPolygon() {
        SimplePolygon2D polygon = SimplePolygon2D.create(new Point2D[] { new Point2D(4, 4), new Point2D(4, -4), new Point2D(-4, -4), new Point2D(-4, 4) });
        Box2D box = new Box2D(-10, 10, -10, 10);

        IPolygon2D comp = polygon.clip(box);

        IBoundary2D boundary = comp.boundary();
    ...
    public void testClone() {
        SimplePolygon2D polygon = new SimplePolygon2D(new Point2D[] { new Point2D(150, 50), new Point2D(150, 150), new Point2D(100, 100), new Point2D(50, 150), new Point2D(50, 50) });
