...
public class StraightLine2DTest extends TestCase {
    ...
    public void testGetBuffer() {
        ...
        // computes buffer
        ICirculinearDomain2D buffer = line.buffer(10);
    ...
    public void testTransformInversion() {
        ...
        ICircleLine2D res = line.transform(inv);
        assertNotNull(res);
    ...
    public void testGetSignedDistancedoubledouble() {
        ...
        line = new StraightLine2D(1, 2, 1, 1);
        assertEquals(line.signedDistance(2, 3), 0, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(1, 3), -Math.sqrt(2) / 2, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(2, 2), Math.sqrt(2) / 2, IShape2D.ACCURACY);
        ...
        line = new StraightLine2D(1, 2, 1, 0);
        assertEquals(line.signedDistance(1, 3), -1, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(1, 1), 1, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(2, 2), 0, IShape2D.ACCURACY);
        ...
        line = new StraightLine2D(1, 2, 0, 1);
        assertEquals(line.signedDistance(1, 3), 0, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(0, 2), -1, IShape2D.ACCURACY);
        assertEquals(line.signedDistance(2, 2), 1, IShape2D.ACCURACY);
    ...
    public void testGetPolarCoefficients() {
        ...
        assertEquals(tab[0], Math.sqrt(2) / 2, IShape2D.ACCURACY);
        assertEquals(tab[1], 5 * Math.PI / 4, IShape2D.ACCURACY);
        ...
        line = new StraightLine2D(1, 2, 1, 0);
        tab = line.polarCoefficients();
        assertEquals(tab[0], 2, IShape2D.ACCURACY);
        assertEquals(tab[1], Math.PI, IShape2D.ACCURACY);
        ...
        line = new StraightLine2D(1, 2, 0, 1);
        tab = line.polarCoefficients();
        assertEquals(tab[0], 1, IShape2D.ACCURACY);
        assertEquals(tab[1], Math.PI / 2, IShape2D.ACCURACY);
    ...
    public void testCopyConstructor() {
        StraightLine2D line = new StraightLine2D(new Point2D(10, 20), new Vector2D(30, 40));
