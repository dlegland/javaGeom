...
public class AffineTransform2DTest extends TestCase {
    ...
    public void testGlideReflection() {
        StraightLine2D line = new StraightLine2D(new Point2D(10, 20), new Point2D(50, 40));
        double distance = 10;
    ...
    public void testLineReflection() {
        // create transform
        AffineTransform2D trans = AffineTransform2D.createLineReflection(new StraightLine2D(new Point2D(10, 20), new Vector2D(3, 2)));
    ...
    public void testIsIsometry() {
        ...
        trans = AffineTransform2D.createLineReflection(new StraightLine2D(new Point2D(10, 20), new Vector2D(3, 2)));
        assertTrue(trans.isIsometry());
    ...
    public void testTransformPointArray() {
        Point2D pts[] = new Point2D[] { new Point2D(10, 20), new Point2D(20, 40), new Point2D(30, 50) };

        AffineTransform2D trans = AffineTransform2D.createTranslation(3, 4);
        Point2D res[] = trans.transform(pts, null);
        Point2D exp[] = new Point2D[] { new Point2D(13, 24), new Point2D(23, 44), new Point2D(33, 54) };
    ...
    public void testAffineMatrix() {
        ...
        assertEquals(s1, matrix[0][0], IShape2D.ACCURACY);
        assertEquals(0, matrix[0][1], IShape2D.ACCURACY);
        assertEquals((1 - s1) * xc, matrix[0][2], IShape2D.ACCURACY);
        assertEquals(0, matrix[1][0], IShape2D.ACCURACY);
        assertEquals(s2, matrix[1][1], IShape2D.ACCURACY);
        assertEquals((1 - s2) * yc, matrix[1][2], IShape2D.ACCURACY);
    }
    ...
    public void testConcatenateAffineTransform2D() {
        ...
        AffineTransform2D ref = AffineTransform2D.createRotation(xc, yc, theta);
        ...
        assertTrue(ref.almostEquals(trans, IShape2D.ACCURACY));
    }
