...
import net.javageom.geom2d.curve.*;
import net.javageom.geom2d.domain.ContinuousOrientedCurve2D;
...
implements SmoothCurve2D, ContinuousOrientedCurve2D, Cloneable {
     ...
     * 
     * @see net.javageom.geom2d.domain.OrientedCurve2D#windingAngle(Point2D)
     */
    ...
    /**
     * @see net.javageom.geom2d.domain.OrientedCurve2D#signedDistance(Point2D)
     */
     ...
     * 
     * @see net.javageom.geom2d.curve.Curve2D#intersections(net.javageom.geom2d.line.LinearShape2D)
     */
    ...
    /**
     * @see net.javageom.geom2d.curve.Curve2D#point(double)
     */
	...
	/**
     * @see net.javageom.geom2d.Shape2D#distance(net.javageom.geom2d.Point2D)
     */
     ...
     * 
     * @see net.javageom.geom2d.Shape2D#distance(double, double)
     */
	 ...
	 * approximation.
	 * 
	 * @see net.javageom.geom2d.Shape2D#sqDistance(net.javageom.geom2d.Point2D)
	 */
