 ...
 * as {@link net.javageom.geom2d.line.LineSegment2D}.
 */
...
implements LinearElement2D, Cloneable {
     ...
     * {@link net.javageom.geom2d.Point2D#ccw(Point2D, Point2D, Point2D) Point2D.ccw}
    ...
    /**
     * Returns false.
     * @see net.javageom.geom2d.curve.ContinuousCurve2D#isClosed()
     */
