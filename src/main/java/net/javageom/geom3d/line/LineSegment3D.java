...
import net.javageom.geom3d.Box3D;
import net.javageom.geom3d.Point3D;
import net.javageom.geom3d.Shape3D;
import net.javageom.geom3d.curve.ContinuousCurve3D;
import net.javageom.geom3d.curve.Curve3D;
...
public class LineSegment3D implements ContinuousCurve3D {
     ...
     * 
     * @see net.javageom.geom3d.curve.Curve3D#position(net.javageom.geom3d.Point3D)
     */
     ...
     * 
     * @see net.javageom.geom3d.curve.Curve3D#singularPoints()
     */
     ...
     * 
     * @see net.javageom.geom3d.curve.Curve3D#getT0()
     */
    public double getT0() {
        return 0;
    }
     ...
     * 
     * @see net.javageom.geom3d.curve.Curve3D#getT1()
     */
    public double getT1() {
        return 1;
    }
     ...
     * 
     * @see net.javageom.geom3d.Shape3D#isBounded()
     */
     ...
     * 
     * @see net.javageom.geom3d.Shape3D#isEmpty()
     */
