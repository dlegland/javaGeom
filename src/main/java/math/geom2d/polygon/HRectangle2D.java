...
/**
 * HRectangle2D defines a rectangle with edges parallel to main axis. Thus, it can not be rotated, contrary to Rectangle2D. This class is actually simply a wrapper of class <code>java.awt.geom.Rectangle2D.Double</code> with interface <code>AbstractPolygon</code>.
 * 
 * @deprecated since 0.11.0
 */
@Deprecated
public class HRectangle2D extends java.awt.geom.Rectangle2D.Double implements IPolygon2D {
