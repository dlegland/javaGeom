...
public class Vector2D implements IGeometricObject2D, Cloneable {
    ...
    public static boolean isColinear(Vector2D v1, Vector2D v2) {
        v1 = v1.normalize();
        v2 = v2.normalize();
        return abs(v1.x * v2.y - v1.y * v2.x) < IShape2D.ACCURACY;
    }
     ...
     */
    public double angle() {
        return Angle2DUtil.horizontalAngle(this);
    }
    ...
    /**
     * Get the cross product with point <code>p</code>. Cross product is defined by :
     * <p>
     * <code> x1*y2 - x2*y1</code>
     * <p>
     * .
     ...
     * 
     * @param theta
     *            the angle of rotation, in radians counter-clockwise
     */
