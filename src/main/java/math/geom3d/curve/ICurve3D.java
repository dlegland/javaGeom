...
public interface ICurve3D extends IShape3D {
    ...
    /**
     * Get the first point of the curve. It must returns the same result as <code>getPoint(getT0())</code>.
     * 
    ...
    /**
     * Get the last point of the curve. It must returns the same result as <code>getPoint(getT1())</code>.
     * 
