...
public class Matrix {
     ...
     *             if the size of matrices do not match
     */
     ...
     *             if the algorithm could not find pivot greater than tolerance
     */
    ...
    public String toString() {
        ...
        res = res.concat("Matrix size : " + Integer.toString(nRows) + " rows and " + Integer.toString(nCols) + " columns.\n");
        for (int r = 0; r < nRows; r++) {
            for (int c = 0; c < nCols; c++)
